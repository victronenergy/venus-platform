...
public:
	...
	static DeviceAlarms *createOpportunityLoadsAlarms(VenusService *service, Notifications *notifications);
	static DeviceAlarms *createEvChargerAlarms(VenusService *service, Notifications *notifications);
